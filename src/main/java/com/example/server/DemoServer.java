...
public class DemoServer {
	...
	public static void main(final String[] args) {
		SpringApplication springApplication = new SpringApplication(DemoServer.class);
		springApplication.setWebEnvironment(false);
		springApplication.run(args);
	}

	String applicationName() {
		return DemoServer.class.getSimpleName();
	}
	...
	@Bean
	Properties gemfireProperties(@Value("${gemfire.locators.host-and-port:localhost[11235]}") String locatorHostPort,
